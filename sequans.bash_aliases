...
alias grepinvhdL='find . -type f -iregex ".*vhd\(l\)?" | xargs grep'
alias grepinvhdl='find . -type f -iname "*vhdl" | xargs grep'
alias grepintex='find . -iname "*tex" | xargs grep'
alias grepinc='find . -regex .*\.[ch] | xargs grep'
alias grepinveri='find . -regex .*\.v | xargs grep'
